...
//adL stands for admin Login Page
public class adL{
    
    public static  void adL(JFrame Frame)
    {
       ...
       f1.setLayout(null);
        ...
        JLabel l1=new JLabel("Administrator Login Page");
